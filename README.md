...
This is the full project behind the article [**How to dockerize your static website with Nginx, automatically renew SSL for domain by Certbot and deploy to your Docker host**](https://docs.blackboard.com)

Thanks goes to koddr for the basis of this project...[Dev.to](https://dev.to/koddr/how-to-dockerize-your-static-website-with-nginx-automatic-renew-ssl-for-domain-by-certbot-and-deploy-it-to-digitalocean-4cjc) @ 27 Jan 2020.
...
git clone https://github.com/moneil/example-base-docker-nginx-certbot.git
